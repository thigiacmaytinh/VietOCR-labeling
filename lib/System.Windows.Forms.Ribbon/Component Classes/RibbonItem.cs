                ...
                if (_checked != value)
                {
                    ...
                    if (value)
                    {
                        if (Canvas is RibbonDropDown)
                        {
                            ...
                            {
                                if (itm is RibbonItemGroup)
                                {
                                    RibbonItemGroup group = (RibbonItemGroup)itm;
                                    foreach (RibbonItem it in group.Items)
                                    {
                                        if (it.CheckedGroup == _checkedGroup && it.Checked && it != this)
                                        {
                                            it.Checked = false;
                                            it.RedrawItem();
                                        }
                                ...
                                else if (itm.CheckedGroup == _checkedGroup && itm.Checked && itm != this)
                                {
                                    itm.Checked = false;
                                    itm.RedrawItem();
                                }

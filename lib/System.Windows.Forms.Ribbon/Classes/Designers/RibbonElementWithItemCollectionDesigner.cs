        ...
        : ComponentDesigner
    {
        ...
        protected virtual DesignerVerbCollection OnGetVerbs()
        {
            return new DesignerVerbCollection(new[] {
               ...
               new DesignerVerb("Add Datetime Picker", AddDatetimePicker),
        ...
        protected virtual void AddDatetimePicker(object sender, EventArgs e)
        {
            CreateItem(typeof(RibbonDatetime));
        }
